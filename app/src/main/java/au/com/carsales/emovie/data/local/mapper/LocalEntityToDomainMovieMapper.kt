 ...
 */
class LocalEntityToDomainMovieMapper @Inject constructor() : Mapper<List<EntityMovieItem>?, List<DomainMovieItem>?> {

    override fun executeMapping(type: List<EntityMovieItem>?): List<DomainMovieItem>? {
